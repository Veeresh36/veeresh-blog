...
* ============================================================
*/
var PinIcon = ({ size = 16 }) => /* @__PURE__ */ jsx("svg", {
	width: size,
	height: size,
	viewBox: "0 0 24 24",
	fill: "currentColor",
...
var SearchIcon = ({ size = 18 }) => /* @__PURE__ */ jsxs("svg", {
	width: size,
	height: size,
	viewBox: "0 0 24 24",
	fill: "none",
...
var BookmarkIcon = ({ size = 18, filled = false }) => /* @__PURE__ */ jsx("svg", {
	width: size,
	height: size,
	viewBox: "0 0 24 24",
...
var GridIcon = ({ size = 18 }) => /* @__PURE__ */ jsxs("svg", {
	width: size,
	height: size,
	viewBox: "0 0 24 24",
	fill: "none",
...
var ListIcon = ({ size = 18 }) => /* @__PURE__ */ jsxs("svg", {
	width: size,
	height: size,
	viewBox: "0 0 24 24",
	fill: "none",
...
var CloseIcon = ({ size = 14 }) => /* @__PURE__ */ jsxs("svg", {
	width: size,
	height: size,
	viewBox: "0 0 24 24",
	fill: "none",
...
var ChevronLeft = ({ size = 20 }) => /* @__PURE__ */ jsx("svg", {
	width: size,
	height: size,
	viewBox: "0 0 24 24",
	fill: "none",
...
var SparkleIcon = ({ size = 16 }) => /* @__PURE__ */ jsx("svg", {
	width: size,
	height: size,
	viewBox: "0 0 24 24",
	fill: "currentColor",
	"aria-hidden": "true",
	children: /* @__PURE__ */ jsx("path", { d: "M12 0 L13.5 9 L22 10.5 L13.5 12 L12 21 L10.5 12 L2 10.5 L10.5 9 Z" })
});
...
function useScrollReveal(threshold = .08) {
	...
	useEffect(() => {
		...
		async function load() {
			try {
				...
				const loaded = (await Promise.allSettled(slugs.map(async (slug, idx) => {
...
var Navbar = () => {
	...
	return /* @__PURE__ */ jsx("nav", {
		className: `nav-glass fixed top-0 left-0 right-0 z-50 border-b border-[#E8E0D5] transition-shadow duration-300 ${scrolled ? "shadow-md" : ""}`,
		"aria-label": "Main navigation",
		children: /* @__PURE__ */ jsxs("div", {
			className: "max-w-[1400px] mx-auto px-6 flex items-center justify-between h-[64px]",
			children: [/* @__PURE__ */ jsx(Link, {
				...
				children: [
					/* @__PURE__ */ jsxs(Link, {
						...
						style: { textDecoration: "none" },
						children: [/* @__PURE__ */ jsx(ChevronLeft, { size: 16 }), " Home"]
					}),
					/* @__PURE__ */ jsxs(Link, {
						to: "/saved",
						...
						children: [/* @__PURE__ */ jsx(BookmarkIcon, {
							...
							className: "absolute -top-1.5 -right-1.5 min-w-[18px] h-[18px] bg-[#E60023] text-white text-[0.6rem] font-bold rounded-full flex items-center justify-center px-1",
					...
					/* @__PURE__ */ jsxs("a", {
						...
						children: [/* @__PURE__ */ jsx(PinIcon, { size: 13 }), " Follow"]
					})
				]
			})]
		})
...
var SkeletonGrid = () => /* @__PURE__ */ jsx("div", {
	className: "masonry-grid",
	children: Array.from({ length: 12 }).map((_, i) => /* @__PURE__ */ jsxs("div", {
		className: "masonry-item",
		children: [/* @__PURE__ */ jsx("div", {
			className: "skeleton",
			style: { height: CARD_HEIGHTS[i % CARD_HEIGHTS.length] }
		}), /* @__PURE__ */ jsxs("div", {
			style: {
				padding: "12px 4px",
				display: "flex",
...
var PinCard = ({ post, index }) => {
	const [ref, isVisible] = useScrollReveal(.04);
	...
	return /* @__PURE__ */ jsx("div", {
		className: `masonry-item ${isVisible ? `reveal-visible ${delayClass}` : "reveal-hidden"}`,
		ref,
		children: /* @__PURE__ */ jsxs("div", {
			ref: cardRef,
			className: "pin-card",
			...
			children: [
				post.featured && /* @__PURE__ */ jsxs("div", {
					className: "featured-badge",
					children: [/* @__PURE__ */ jsx(SparkleIcon, { size: 10 }), " Featured"]
				}),
				/* @__PURE__ */ jsx("button", {
					type: "button",
					onClick: (e) => {
				...
				/* @__PURE__ */ jsxs(Link, {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						style: { height: post.heightPx },
						children: [
							post.image && !imgError ? /* @__PURE__ */ jsx("img", {
								src: post.image,
								alt: post.title,
								className: "card-img",
								loading: "lazy",
						...
						children: [
							...
							post.tags?.length > 0 && /* @__PURE__ */ jsx("div", {
								style: {
									display: "flex",
									flexWrap: "wrap",
									gap: 5,
								...
								children: post.tags.slice(0, 2).map((t) => /* @__PURE__ */ jsx("span", {
									className: "tag-chip",
									children: t
								}, t))
							}),
...
var EmptyState = ({ query, onClear }) => /* @__PURE__ */ jsxs("div", {
	style: {
		textAlign: "center",
		padding: "80px 24px"
	},
	children: [
		...
		/* @__PURE__ */ jsx("p", {
			...
			children: query ? `No results for "${query}". Try a different search.` : "No posts in this category yet."
		}),
		/* @__PURE__ */ jsx("button", {
			type: "button",
			onClick: onClear,
...
function AllBlogs() {
	...
	const filtered = useMemo(() => {
		...
		if (query.trim()) {
			...
			result = result.filter((p) => p.title.toLowerCase().includes(q) || p.excerpt.toLowerCase().includes(q) || p.category.toLowerCase().includes(q) || p.tags.some((t) => t.toLowerCase().includes(q)));
		}
	...
	useEffect(() => {
		const onScroll = () => {
			if (window.innerHeight + window.scrollY >= document.body.offsetHeight - 400 && hasMore) setVisibleCount((v) => v + 16);
		};
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(GlobalStyles, {}), /* @__PURE__ */ jsxs("div", {
		style: {
			background: "#FAF8F4",
			minHeight: "100vh"
		},
		children: [
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", { children: [
						...
						/* @__PURE__ */ jsx("p", {
							...
							children: loading ? "Loading posts…" : `${posts.length} post${posts.length !== 1 ? "s" : ""} published`
						})
					] }), /* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsx(SearchIcon, { size: 17 }),
								/* @__PURE__ */ jsx("label", {
									htmlFor: "blog-search",
									className: "sr-only",
			...
			/* @__PURE__ */ jsx("div", {
				className: "filter-bar fade-up d-300",
				children: /* @__PURE__ */ jsxs("div", {
					style: {
						maxWidth: 1400,
						margin: "0 auto",
					...
					children: [/* @__PURE__ */ jsx("div", {
						...
						children: categories.map((cat) => /* @__PURE__ */ jsxs("button", {
							...
							children: [cat, cat !== "All" && /* @__PURE__ */ jsx("span", {
								style: {
									marginLeft: 4,
									opacity: .6
								},
								children: posts.filter((p) => p.category === cat).length
							})]
						}, cat))
					}), /* @__PURE__ */ jsxs("div", {
						style: {
						...
						children: [
							(query || activeCategory !== "All") && /* @__PURE__ */ jsxs("button", {
								type: "button",
								...
								children: [/* @__PURE__ */ jsx(CloseIcon, { size: 11 }), " Clear"]
							}),
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("button", {
									...
									title: "Grid view",
									children: /* @__PURE__ */ jsx(GridIcon, { size: 16 })
								}), /* @__PURE__ */ jsx("button", {
									type: "button",
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: !loading && !error && /* @__PURE__ */ jsxs("p", {
					style: {
						fontSize: "0.8rem",
						color: "#B0A49A",
						marginBottom: 0
			...
			/* @__PURE__ */ jsxs("main", {
				...
				children: [
					loading && /* @__PURE__ */ jsx(SkeletonGrid, {}),
					...
					!loading && !error && filtered.length === 0 && /* @__PURE__ */ jsx(EmptyState, {
						query,
						onClear: clearFilters
					}),
					!loading && !error && filtered.length > 0 && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("div", {
						className: "masonry-grid",
						children: visible.map((post, i) => viewMode === "list" ? /* @__PURE__ */ jsx(ListCard, {
							post,
							index: i
						}, post.slug) : /* @__PURE__ */ jsx(PinCard, {
							post,
							index: i
						}, post.slug))
					}), /* @__PURE__ */ jsx("div", {
						...
						children: hasMore ? /* @__PURE__ */ jsx("button", {
							type: "button",

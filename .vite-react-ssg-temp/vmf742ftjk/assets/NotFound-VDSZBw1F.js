...
* ============================================================
*/
var HomeIcon = ({ size = 16 }) => /* @__PURE__ */ jsxs("svg", {
	width: size,
	height: size,
	viewBox: "0 0 24 24",
	fill: "none",
...
var SearchIcon = ({ size = 16 }) => /* @__PURE__ */ jsxs("svg", {
	width: size,
	height: size,
	viewBox: "0 0 24 24",
	fill: "none",
...
var BackIcon = ({ size = 16 }) => /* @__PURE__ */ jsx("svg", {
	width: size,
	height: size,
	viewBox: "0 0 24 24",
	fill: "none",
...
var NotFoundStyles = () => /* @__PURE__ */ jsx("style", { children: `
...
function NotFound() {
	...
	const handleSearchSubmit = (e) => {
		e.preventDefault();
		if (searchQuery.trim()) window.location.href = `/#blog?search=${encodeURIComponent(searchQuery)}`;
	};
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(NotFoundStyles, {}), /* @__PURE__ */ jsxs("div", {
		className: "min-h-screen bg-[#FAF8F4] text-[#1A1612] flex flex-col justify-between relative overflow-hidden px-8 font-body",
		children: [
			/* @__PURE__ */ jsx("div", { className: "premium-blur-circle w-[500px] h-[500px] -top-20 -left-20 animate-slowPulse" }),
			/* @__PURE__ */ jsx("div", {
			...
			/* @__PURE__ */ jsxs("header", {
				role: "banner",
				className: "max-w-[1240px] w-full mx-auto h-[90px] flex items-center justify-between relative z-10",
				children: [/* @__PURE__ */ jsxs("a", {
					...
					children: "Back to Curation Index"
				})]
			}),
			/* @__PURE__ */ jsxs("main", {
				id: "main-content",
				role: "main",
				className: "max-w-[1240px] w-full mx-auto flex-1 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10 pt-8 pb-16",
				children: [/* @__PURE__ */ jsxs("div", {
					className: "animate-fadeUp",
					children: [
						/* @__PURE__ */ jsxs("div", {
							className: "inline-flex items-center gap-2 bg-[#F2EDE4] border border-[#E8E0D5] rounded-full px-4 py-1.5 text-xs font-bold text-[#8C7E74] uppercase tracking-widest mb-6",
							children: [/* @__PURE__ */ jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-[#E60023]" }), "Error Code: 404"]
						}),
						/* @__PURE__ */ jsxs("h1", {
							className: "font-display text-[clamp(2.5rem,6vw,4.5rem)] leading-[1.05] tracking-tight text-[#1A1612] mb-6",
							children: [
								"This layout has ",
								/* @__PURE__ */ jsx("br", {}),
								/* @__PURE__ */ jsx("em", {
						...
						/* @__PURE__ */ jsx("p", {
							className: "text-[1.05rem] text-[#8C7E74] leading-[1.75] max-w-[480px] mb-10 font-light",
							children: "The story, space, or curated product recommendation you are seeking doesn't exist here anymore—or perhaps it's moved onto a new collection layout board."
						}),
						/* @__PURE__ */ jsxs("form", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("a", {
								...
								children: [/* @__PURE__ */ jsx(HomeIcon, { size: 14 }), "Return Home"]
								...
								children: [/* @__PURE__ */ jsx(BackIcon, { size: 14 }), "Go Back One Page"]
							})]
						})
					]
				}), /* @__PURE__ */ jsxs("div", {
					className: "hidden lg:flex justify-center items-center relative animate-luxuryFloat",
					"aria-hidden": "true",
					children: [/* @__PURE__ */ jsxs("div", {
						className: "w-[380px] aspect-[3/4] bg-white rounded-2xl shadow-xl border border-[#E8E0D5] p-6 flex flex-col justify-between relative hover-lift",
						children: [
							/* @__PURE__ */ jsxs("div", {
								className: "flex justify-between items-center border-b border-[#FAF8F4] pb-4",
								children: [/* @__PURE__ */ jsx("span", {
									className: "font-display text-xl text-black/10",
							...
							/* @__PURE__ */ jsxs("div", {
								className: "text-center my-auto flex flex-col items-center justify-center",
								children: [
									/* @__PURE__ */ jsx("span", {
										className: "text-[7rem] leading-none select-none filter drop-shadow-md",
										children: "404"
									}),
									/* @__PURE__ */ jsx("div", { className: "w-12 h-[1px] bg-[#E8E0D5] my-4" }),
									/* @__PURE__ */ jsx("span", {
										className: "text-[0.7rem] uppercase font-bold tracking-[0.25em] text-[#8C7E74]",
										children: "Missing Inspiration"
									})
								]
							}),
							/* @__PURE__ */ jsxs("div", {
								className: "flex justify-between items-center border-t border-[#F2EDE4] pt-4 mt-auto",
								children: [/* @__PURE__ */ jsx("span", {
									className: "text-[0.65rem] text-[#8C7E74] font-medium uppercase tracking-wider",
									children: "Veeresh Bashetti"
								}), /* @__PURE__ */ jsx("span", {
									className: "w-5 h-5 rounded-full bg-[#E60023] flex items-center justify-center text-[0.45rem] font-bold text-white",
									children: "P"
								})]
							})
						]
						...
						children: [/* @__PURE__ */ jsx("span", {
							...
							className: "block text-[0.7rem] font-bold text-[#8C7E74] uppercase tracking-wider mb-0.5",
							children: "Recommended"
						}), /* @__PURE__ */ jsx("span", {
							className: "font-display text-xs text-[#1A1612] leading-tight block",
							children: "Minimalist Habits inside the Index"
						})] })]
					})]
				})]
			}),
			/* @__PURE__ */ jsxs("footer", {
				role: "contentinfo",
				className: "max-w-[1240px] w-full mx-auto h-[60px] flex items-center justify-between border-t border-[#E8E0D5] relative z-10 text-[0.78rem] text-[#8C7E74]",

...
//#region src/pages/PrivacyPolicy.jsx
var SITE = {
...
var sections = [
	{
		...
		content: [{
			type: "text",
			value: "This Privacy Policy describes how Veeresh Bashetti ('I', 'me', or 'my') collects, uses, and shares information when you visit veereshbashetti.com (the 'Site'). I take your privacy seriously and I've written this in plain language so it's actually readable."
		}, {
			type: "text",
			value: "By using the Site, you agree to the collection and use of information in accordance with this policy. If you have any questions, feel free to reach out directly."
		}]
	},
	{
		...
		content: [
			...
			{
				type: "text",
				value: "Certain features — dark mode preference, font size, bookmarks, highlights, and reading streak — are stored in your browser's localStorage. This data never leaves your device and I cannot access it."
			}
		]
	},
	{
		...
		content: [
			{
				type: "text",
				value: "The Site uses a small number of cookies. A cookie is a tiny file placed on your device that helps the site work properly."
			},
			{
				type: "table",
				rows: [
					{
						...
						purpose: "Measures site traffic anonymously",
					...
					},
					{
						...
						purpose: "Authenticates comment API requests",
			...
			{
				type: "text",
				value: "You can disable cookies in your browser settings at any time. Doing so may affect how some features of the Site function, but the articles will still be fully readable."
			}
		]
	},
	{
		...
		content: [
			{
				type: "text",
				value: "I use a handful of third-party services to run the Site. Each has their own privacy policy that governs how they handle data."
			},
			{
				type: "cards",
				items: [
			...
			{
				type: "text",
				value: "Affiliate links — some articles contain affiliate links (primarily Amazon). If you click one and make a purchase, I may earn a small commission at no extra cost to you. These links are always disclosed near the relevant content."
			}
		]
	},
	{
	...
	},
	{
		...
		content: [
			{
				type: "text",
				value: "Depending on where you live, you may have certain rights under applicable data protection laws (including GDPR if you're in the EU/EEA, or India's DPDP Act)."
			},
			{
				type: "list",
				items: [
			...
			{
				type: "text",
				value: "To exercise any of these rights, simply email me. I'll respond within 30 days."
			}
		]
	},
	{
		...
		content: [{
			type: "text",
			value: "The Site is not directed at children under 13 years of age. I do not knowingly collect personal information from children. If you believe a child has submitted personal data to this Site, please contact me and I will remove it promptly."
		}]
	},
	{
		id: "changes",
		...
		content: [{
			type: "text",
			value: "I may update this policy from time to time. When I do, I'll update the 'Last updated' date at the top of this page. Significant changes will be noted clearly. Continued use of the Site after changes constitutes acceptance of the revised policy."
		}]
	},
	{
		id: "contact",
		...
		content: [{
			type: "text",
			value: "If you have any questions, concerns, or requests regarding this Privacy Policy or your personal data, please reach out:"
		}, {
			type: "contact",
			name: SITE.name,
			email: SITE.email,
...
var SectionContent = ({ content, dark }) => {
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: content.map((block, i) => {
			...
			if (block.type === "table") return /* @__PURE__ */ jsx("div", {
				className: "overflow-x-auto mt-4 rounded-xl border",
				style: { borderColor: border },
				children: /* @__PURE__ */ jsxs("table", {
					className: "w-full text-[0.85rem] border-collapse",
					...
					}) }), /* @__PURE__ */ jsx("tbody", { children: block.rows.map((row, j) => /* @__PURE__ */ jsxs("tr", {
						style: { borderBottom: j < block.rows.length - 1 ? `1px solid ${border}` : "none" },
						children: [
							/* @__PURE__ */ jsx("td", {
								className: "px-4 py-3 font-medium text-[0.82rem]",
								style: { color: dark ? "#FAF8F4" : "#1A1612" },
								children: row.name
							}),
							/* @__PURE__ */ jsx("td", {
			...
			if (block.type === "cards") return /* @__PURE__ */ jsx("div", {
				...
				children: block.items.map((card, j) => /* @__PURE__ */ jsxs("a", {
					href: card.link,
					target: "_blank",
					rel: "noopener noreferrer",
				...
				/* @__PURE__ */ jsxs("header", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("p", {
							...
							style: { color: dark ? "rgba(250,248,244,0.5)" : "#7A6E64" },
							children: "A plain-language explanation of what data is collected on this site, how it's used, and your rights."
						}),
						/* @__PURE__ */ jsxs("div", {
							className: "flex items-center gap-3 mt-6 text-[0.78rem]",
							style: { color: dark ? "rgba(250,248,244,0.4)" : "#9C8E84" },
							children: [
								/* @__PURE__ */ jsxs("span", { children: ["Last updated: ", /* @__PURE__ */ jsx("strong", {
									style: {
						...
						children: [
							...
							/* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsxs("p", {
									...
									children: [
										"This policy was written by a human — not generated by AI. It reflects the actual practices of this site as of ",
										LAST_UPDATED,
										". If anything here seems unclear or incorrect, please email me."
									]
								})
							})
						]
